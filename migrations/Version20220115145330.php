 ...
 */
final class Version20220115145330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(13) NOT NULL, titre LONGTEXT NOT NULL, nombre_pages INT NOT NULL, date_de_parution DATE NOT NULL, note INT NOT NULL, UNIQUE INDEX UNIQ_AC634F99CC1CF4E6 (isbn), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
